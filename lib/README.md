This directory contains the low-level tensor libraries for Torch.

There are multiple variants of the library, summarized here:

* TH = TorcH (include here)

The rest are not part of this library
...
Torch employs reference counting in order to permit tensors to provide
